    ...
    if(isset($_POST['btnSubmit'])){
      ...
      $password2 = sanitize_data($_POST['txtPassword2']);
        ...
        if ($password1 != $password2) {
          ...
          $sql = "INSERT INTO admin_user (username,email, `password`,user_role) VALUES('$username','$email', '$hashed_password', '$user_type')";
            ...
            <form style="width: 400px; margin: auto" action="signup.php" method="post">              
              ...
              <div class="form-group">
                              <select name="user_type" class="form-control" id="">
                                ...
                                <?php
                                  $carQuery = mysqli_query($conn, "SELECT * FROM `admin_role`");
                                  while($carRow=mysqli_fetch_assoc($carQuery)){
                                ?>
                                  <option value="<?=$carRow['id'] ?>"><?=$carRow['roles'] ?></option>
                                <?php
                                  }
                                ?>
                              </select>
