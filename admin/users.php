<?php
    ...
    if (isset($_POST['btnUpdate'])){
        ...
        if(empty( $file_name)){
            ...
            if (!in_array($file_extension[1], $permited_extentions)) {
...
// exit();
$spec = "";
        $query = "SELECT * FROM users WHERE id = '$user' AND user_type = 0";
        ...
        <tbody>
            <tr>
                <form class='form-horizontal' action='users.php' method='post' enctype='multipart/form-data'>
                    ...
                    <td>
                        <a class='btn btn-primary btn-lg' href='edit.php?action=$userid'>Edit</a>
                    </td>
                </form>
            </tr>
        </tbody>
